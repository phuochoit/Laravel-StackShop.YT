  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="{{ asset('assets/admin') }}/index.html"><img src="{{asset('assets/admin')}}/images/logo.svg" class="mr-2" alt="logo"/></a>
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item dropdown">
            <a class="nav-link count-indicator dropdown-toggle" id="notificationDropdown" href="{{ asset('assets/admin') }}#"/ data-toggle="dropdown">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="{{ asset('assets/admin') }}#"/ data-toggle="dropdown" id="profileDropdown">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div id="right-sidebar" class="settings-panel">
        ...
        <ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="todo-tab" data-toggle="tab" href="{{ asset('assets/admin') }}#/todo-section" role="tab" aria-controls="todo-section" aria-expanded="true">TO DO LIST</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="chats-tab" data-toggle="tab" href="{{ asset('assets/admin') }}#/chats-section" role="tab" aria-controls="chats-section">CHATS</a>
          </li>
        </ul>
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="{{ asset('assets/admin') }}#/ui-basic" aria-expanded="false" aria-controls="ui-basic">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="{{ asset('assets/admin') }}#/form-elements" aria-expanded="false" aria-controls="form-elements">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="{{ asset('assets/admin') }}#/charts" aria-expanded="false" aria-controls="charts">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="{{ asset('assets/admin') }}#/tables" aria-expanded="false" aria-controls="tables">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="{{ asset('assets/admin') }}#/icons" aria-expanded="false" aria-controls="icons">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="{{ asset('assets/admin') }}#/auth" aria-expanded="false" aria-controls="auth">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="{{ asset('assets/admin') }}#/error" aria-expanded="false" aria-controls="error">
      ...
      <div class="main-panel">
                 ...
                 <div class="justify-content-end d-flex">
                  <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuDate2">
                      <a class="dropdown-item" href="{{ asset('assets/admin') }}#">/January - March</a>
                      <a class="dropdown-item" href="{{ asset('assets/admin') }}#">/March - June</a>
                      <a class="dropdown-item" href="{{ asset('assets/admin') }}#">/June - August</a>
                      <a class="dropdown-item" href="{{ asset('assets/admin') }}#">/August - November</a>
                    </div>
                  </div>
                 </div>
                </div>
              ...
              <div class="card">
                <div class="card-body">
                 <div class="d-flex justify-content-between">
                  ...
                  <a href="{{ asset('assets/admin') }}#"/ class="text-info">View all</a>
                 </div>
                  <p class="font-weight-500">The total number of sessions within the date range. It is the period time a user is actively engaged with your website, page or app, etc</p>
              ...
              <div class="card position-relative">
                <div class="card-body">
                  <div id="detailedReports" class="carousel slide detailed-report-carousel position-static pt-2" data-ride="carousel">
                    ...
                    <a class="carousel-control-prev" href="{{ asset('assets/admin') }}#/detailedReports" role="button" data-slide="prev">
                      <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                      <span class="sr-only">Previous</span>
                    </a>
                    <a class="carousel-control-next" href="{{ asset('assets/admin') }}#/detailedReports" role="button" data-slide="next">
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2021.  Premium <a href="{{ asset('assets/admin') }}/https://www.bootstrapdash.com/" target="_blank">Bootstrap admin template</a> from BootstrapDash. All rights reserved.</span>
